export async function onRequest(context) {
  ...
  if (isMainApp) {
    ...
    const productionWeekCss = '<link rel="stylesheet" href="/css/production-week.css?v=20260915-2">';
    ...
    const homeQueueScript = '<script src="/js/home-full-queue.js?v=20260915-1" defer></script>';
    ...
    const productionWeekScript = '<script src="/js/production-week.js?v=20260915-2" defer></script>';
