export async function onRequest(context) {
  ...
  if (isMainApp) {
    ...
    const groupingCss = '<link rel="stylesheet" href="/css/order-grouping.css?v=20260910-4">';
    ...
    const groupingScript = '<script src="/js/order-grouping.js?v=20260910-5" defer></script>';
